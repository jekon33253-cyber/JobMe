...
const content = {
  pl: {
    ...
    intro: 'Niniejsza Polityka Prywatności określa zasady przetwarzania danych osobowych przez GRUPA JOBME S.A. z siedzibą we Wrocławiu (ul. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931).',
    sections: [
      { title: '1. Administrator Danych', text: 'Administratorem Twoich danych osobowych jest GRUPA JOBME S.A. z siedzibą we Wrocławiu (ul. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931). Kontakt: rekrutacja@jobme.pl.' },
      ...
      { title: '7. Twoje prawa', text: 'Masz prawo do: dostępu do danych, ich sprostowania, usunięcia, ograniczenia przetwarzania, przenoszenia oraz wniesienia sprzeciwu. W tym celu napisz na rekrutacja@jobme.pl.' },
  ...
  ua: {
    ...
    intro: 'Ця Політика конфіденційності визначає правила обробки персональних даних компанією GRUPA JOBME S.A. зі штаб-квартирою у Вроцлаві (вул. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931).',
    sections: [
      { title: '1. Адміністратор даних', text: 'Адміністратором ваших персональних даних є GRUPA JOBME S.A. зі штаб-квартирою у Вроцлаві (вул. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931). Контакт: rekrutacja@jobme.pl.' },
      ...
      { title: '7. Ваші права', text: 'Ви маєте право на: доступ до даних, виправлення, видалення, обмеження обробки, перенесення та заперечення. Для цього напишіть на rekrutacja@jobme.pl.' },
      ...
      { title: '9. Зміни в политиці', text: 'Ми залишаємо за собою право оновлювати цю політику. Про суттєві зміни повідомимо на головній сторінці.' },
    ],
  ...
  en: {
    ...
    intro: 'This Privacy Policy outlines how GRUPA JOBME S.A., based in Wrocław (ul. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931), processes your personal data.',
    sections: [
      { title: '1. Data Controller', text: 'The controller of your personal data is GRUPA JOBME S.A., based in Wrocław (ul. Powstańców Śląskich 7A, 53-332 Wrocław, NIP: 8971826557, REGON: 364989820, KRS: 0000628931). Contact: rekrutacja@jobme.pl.' },
      ...
      { title: '7. Your rights', text: 'You have the right to: access, rectification, erasure, restriction of processing, data portability, and objection. Write to rekrutacja@jobme.pl to exercise these rights.' },
